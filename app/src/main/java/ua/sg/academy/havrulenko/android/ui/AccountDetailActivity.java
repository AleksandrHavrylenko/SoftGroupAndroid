...
public class AccountDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DataBindingUtil.setContentView(this, R.layout.activity_account_detail);
        String email = getIntent().getStringExtra(KEY_SESSION_EMAIL);
        getSupportFragmentManager().beginTransaction().replace(R.id.container, AccountDetailsFragment.newInstance
                (email, true))
                .commit();
